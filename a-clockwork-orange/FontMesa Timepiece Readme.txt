...
Font Name - Timepiece v1.2 (Freeware)
*******************************************************
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	Timepiece is a font based on the logo from the movie A Clockwork Orange®
	a Warner Bros Trademark.

	Timepiece includes two fonts, the first Timepiece font is the basic lettering
	and the second font Timepiece 3D Backfill is designed to be placed behind the
	first Timepiece font to give the illusion of depth to the letters. This could
	have been accomplished in one font by creating an open faced font with the 3D
	extension off to one side but with an open faced font you can't overlap a
	characters spacing without one character showing through the other one next to it.
	To further create the 3d illusion the characters should overlap slightly over
	the letter next to it, so it was much easier to create two solid fonts that you 
	could layer in any position you like giving you the 3D illusion within a 2 dimensional
	image or piece of paper. 
